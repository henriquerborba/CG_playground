...
Vector3 Matrix::operator*(Vector3 v)
{
    ...
    temp.p[3][0] = 1;
    Matrix temp2 = (*this * temp);
    return Vector3(temp2.p[0][0], temp2.p[1][0], temp2.p[2][0]);
}
...
Matrix Matrix::scale2d(float sx, float sy)
{
...
Matrix Matrix::translate2d(float tx, float ty)
{
    Matrix temp = createIdentity(3);
    temp(0, 2) = tx;
    temp(1, 2) = ty;
...
Matrix Matrix::rotate2d(float angle)
{
...
// transformations 3d
Matrix Matrix::scale3d(float sx, float sy, float sz)
{
    Matrix temp = createIdentity(4);
    temp(0, 0) = sx;
    temp(1, 1) = sy;
    temp(2, 2) = sz;
    return temp;
...
Matrix Matrix::translate3d(float tx, float ty, float tz)
{
    Matrix temp = createIdentity(4);
    temp(0, 3) = tx;
    temp(1, 3) = ty;
